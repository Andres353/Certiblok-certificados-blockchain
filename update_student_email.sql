-- Script para actualizar el email de un estudiante en Supabase
-- 
-- IMPORTANTE: 
...
-- 2. Elige una de las opciones siguientes según cómo quieras identificar al estudiante:
--    - OPCIÓN 1: Por email actual del estudiante
--    - OPCIÓN 2: Por ID (UUID) del estudiante
-- 3. Ejecuta este script en el SQL Editor de Supabase

-- ============================================================
-- OPCIÓN 1: Actualizar por EMAIL ACTUAL del estudiante
-- ============================================================
...
-- ============================================================
-- OPCIÓN 2: Actualizar por ID (UUID) del estudiante
-- ============================================================
...
--     updated_at = NOW()
-- WHERE 
--     id = 'UUID_DEL_ESTUDIANTE_AQUI'::uuid  -- ⚠️ CAMBIA ESTE UUID
--     AND role = 'student';
...
--     updated_at
-- FROM users
-- WHERE id = 'UUID_DEL_ESTUDIANTE_AQUI'::uuid  -- ⚠️ CAMBIA ESTE UUID
--     AND role = 'student';
...
BEGIN
    ...
    IF NOT student_exists THEN
        RAISE EXCEPTION 'No se encontró un estudiante con el email: %', old_email;
    END IF;
